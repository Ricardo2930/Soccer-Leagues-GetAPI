...
const getDataGerman = async () => {
    const response = await fetch("https://www.thesportsdb.com/api/v1/json/3/search_all_teams.php?l=German%20Bundesliga");
    const data = await response.json();
    const leagueGerman = data.teams;
    // console.log(data);
    // console.log(leagueGerman);

    container.innerHTML = "";
    leagueGerman.forEach((element) => {
