...
const getDataPortuguese = async () => {
    const response = await fetch('https://www.thesportsdb.com/api/v1/json/3/search_all_teams.php?l=Portuguese%20Primeira%20Liga')
    const data = await response.json()
    const leaguePortuguese = data.teams
    // console.log(data)
    // console.log(leaguePortuguese)

    container.innerHTML = ""
    leaguePortuguese.forEach(element => {
